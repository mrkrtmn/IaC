# Task execution role: ECS lo asume al lanzar la task para pull de ECR y leer SSM Parameters.
...
# Permiso adicional: leer SSM Parameters (SecureString) y descifrar con la KMS key default.
